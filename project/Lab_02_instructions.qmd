...
::: callout-important
This lab was updated on 8/6 to include some explicit instructions for importing and exporting data! (Nicky 8/6/26)
:::
...
2.  **Convert the remaining `Q53_` items** (SNAP, SSI, SSDI, cash assistance/TANF, unemployment insurance, free/reduced school meals, and WIC) to simple 0/1 indicators (1 = "Yes", 0 = "No").
    - Free/reduced school meals is only asked of households with a child aged 5-18 — since your Project 3 population already requires `ANY_CHILDHH_5_18 == "Yes"`, this item should be answered for everyone in your filtered sample.
